...
PAGE_KEYS = {
              "login": 'webb.login',
              "logout": 'webb.logout',
              "hubblecast_sidebar": "webb.hubblecast_sidebar",
              "access_denied": "webb.access_denied",
              "shop_right_column": "djangoplicity.shop_right_column",
              "free_order_form": "djangoplicity.free_order_form",
              "frontpage_rightcol": "webb.frontpage_rightcol",
              "image_archive_top": "webb.image_archive_top",
            }

register_page_key( 'webb', PAGE_KEYS["login"], _('Login page'), _('Displayed above the login form.') )
register_page_key( 'webb', PAGE_KEYS["logout"], _('Logout page'), _('Displayed on the logout page.') )
register_page_key( 'webb', PAGE_KEYS["hubblecast_sidebar"], _('Hubblecast Sidebar'), _('Right-column displayed on the hubblecast feature page') )
register_page_key( 'webb', PAGE_KEYS["access_denied"], _('Access Denied'), _('Displayed when users are denied access to embargoed/staging resources.') )
register_page_key( 'webb', PAGE_KEYS["frontpage_rightcol"], _('Frontpage right column'), _('Displayed above archive picture of the day.') )
register_page_key( 'webb', PAGE_KEYS["image_archive_top"], _('Image archive top'), _('Displayed just below the title in image archive list views.') )
