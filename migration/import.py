...
link_replacements = {
	...
	'/bin/exhibitions.pl' : '/extras/exhibitions/',
...
pagestasks = [
	...
	PageMigrationTask( SpacetelescopePageDocument( 'about_us/heic/index.html', new_url="/about_us/heic/" ) ),
	...
	PageMigrationTask( SpacetelescopePageDocument( 'projects/20anniversary/events.html' ) ),
