...
TOKEN_FILE = '/home/hubbleadm/config/youtube/youtube-oauth2-token.json'
CLIENT_SECRET = '/home/hubbleadm/config/youtube/client-secret.json'
...
if __name__ == '__main__':
    argparser.add_argument('--client-secret', help='Client secret JSON file', required=True)

    args = argparser.parse_args(['--noauth_local_webserver', '--client-secret', CLIENT_SECRET])

    flow = flow_from_clientsecrets(args.client_secret, message=message, scope=YOUTUBE_SCOPE)
